...
| 상승 전 압축 | ATR 비율 0.8 이하, 거래량 1.2배 이상, 당일 고저폭 상위 40% 마감 | 카드 선택 시 이 수치 조건을 그대로 적용 |
| 강한 돌파 | 거래량 2.0배 이상, 종가 +2.0% 이상, 당일 고저폭 상위 15% 마감 | 카드 선택 시 이 수치 조건을 그대로 적용 |
| 거래량 확장 | 거래량 2.5배 이상, 60일 거래량 z-score 1.5 이상 | 카드 선택 시 이 수치 조건을 그대로 적용 |
| 수급 개선 | 최근 20일 상승일 거래량합 ÷ 하락일 거래량합 1.4배 이상, OBV 기울기 0.15 이상 | 카드 선택 시 이 수치 조건을 그대로 적용 |
